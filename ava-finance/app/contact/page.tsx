...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Reach AVA Finance — Karol Bagh, New Delhi. Phone, email, business hours, social channels and our Grievance Redressal Officer.",
};
      ...
      <Section texture="dots">
        <div className="grid gap-16 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div className="flex flex-col gap-8">
            {[
              ["Office", site.contact.address, site.contact.hours],
            ].map(([k, v, sub]) => (
              <Reveal key={k} className="flex flex-col gap-3">
                <span className="eyebrow text-accent">{k}</span>
                <p className="font-display text-xl leading-snug text-ink">{v}</p>
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <Reveal className="flex flex-col gap-4">
            ...
            <p className="measure leading-relaxed text-ink-soft">
              ...
              here to help. Complaints are acknowledged within 48 hours, and
              unresolved matters can be escalated to the RBI Ombudsman.
            </p>
          </Reveal>
            ...
            <div className="rounded-3xl border border-line bg-canvas p-8">
              ...
              <dl className="mt-6 flex flex-col gap-4 text-sm">
                ...
                <div className="flex flex-col gap-1 border-t border-line pt-4 sm:flex-row sm:justify-between sm:gap-6">
                  ...
                  <dd className="text-ink sm:max-w-[20ch] sm:text-right">
